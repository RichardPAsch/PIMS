            ...
            var profileListing = new List<Profile>
                          {
                                new Profile
                                {
                                    ...
                                    Price = 1.94M,
                                    DividendYield = 3.99M,
                                    ExDividendDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 8),
                                    DividendPayDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 13),
                                ...
                                new Profile
                                {
                                    ...
                                    Price = 1.32M,
                                    DividendYield = 4.9M,
                                    ExDividendDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 10),
                                    DividendPayDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 19),
                                    EarningsPerShare = 3.21M,
                                    LastUpdate = DateTime.UtcNow.AddHours(-4),
                                    PE_Ratio = 15.66M,
                                ...
                                new Profile
                                {
                                    ...
                                    DividendYield = 6.14M,
                                    Price = 1.09M,
                                    ExDividendDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 9),
                                    DividendPayDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 14),
                                ...
                                new Profile
                                {
                                    ...
                                    Price = .992M,
                                    DividendYield = 6.82M,
                                    ExDividendDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 5),
                                    DividendPayDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 11),
                                ...
                                new Profile
                                {
                                    ...
                                    Price = 1.92M,
                                    DividendYield = 6.69M,
                                    ExDividendDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 14),
                                    DividendPayDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 28),
                                    EarningsPerShare = 4.21M,
                                    LastUpdate = DateTime.UtcNow.AddDays(-11),
                                    PE_Ratio = 5.96M,
