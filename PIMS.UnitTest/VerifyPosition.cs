...
namespace PIMS.UnitTest
{
    ...
    public class VerifyPosition
    {
        ...
        private const string UrlBase = "http://localhost/PIMS.Web.API/api/Position";
        ...
        [Test]
        // ReSharper disable once InconsistentNaming
        public void Controller_can_POST_a_new_fake_Position_for_a_given_users_asset() {
            ...
            //Assert.IsTrue(profileEntity.AssetId != Guid.Empty);
        }
        ...
        //        AssetId = new Guid("dbf1590e-b99f-468d-a44e-e5e8f86c5f86"),
        //        UnitPrice = 201.06M,
        //        DividendFreq = "Q",
        //        DividendYield = 6.79M,
        //        DividendRate = 1.31M,
